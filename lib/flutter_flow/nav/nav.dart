      ...
      errorBuilder: (context, state) => appStateNotifier.showSplashImage
          ? Builder(
              builder: (context) => Container(
                color: Colors.white,
                child: Image.asset(
                  'assets/images/logo_tecadilabs.png',
                  fit: BoxFit.fitWidth,
                ),
              ),
            )
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => EditPageWidget(
            ...
            paramEmail: params.getParam('paramEmail', ParamType.String),
            documento: params.getParam(
                'documento', ParamType.DocumentReference, false, ['users']),
